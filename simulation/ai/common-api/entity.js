...
m.Template = m.Class({
	...
	"maxMorale": function() { return +(this.get("Morale/Max") || 0); },

	"moraleInfluence": function() { return +(this.get("MoraleInfluence/Significance") || 0); },
...
m.Entity = m.Class({
	...
	"morale": function() { return this._entity.morale !== undefined ? this._entity.morale : undefined; },
	"isHurt": function() { return this.hitpoints() < this.maxHitpoints(); },
	"healthLevel": function() { return this.hitpoints() / this.maxHitpoints(); },
	"moraleLevel": function() { return this.morale() / this.maxMorale(); },
	"moraleInfluence": function() { return this.moraleInfluence(); },
