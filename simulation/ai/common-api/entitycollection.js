...
m.EntityCollection.prototype.setFormation = function(formationName)
{
	Engine.PostCommand(PlayerID, { "type": "formation", "entities": this.toIdArray(), "name": formationName, "queued": false });
	return this;
};
